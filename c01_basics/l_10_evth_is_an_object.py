...
def f(r_var, l_var):
    r_var += 1
    l_var.append(5)
    print(f"inside function: regular_var={r_var}, location={id(r_var)} list_var={l_var}, location={id(l_var)}")


regular_var = 1
list_var = [1, 2, 3]
print(f"before:          regular_var={regular_var}, location={id(regular_var)}, list_var={list_var}, location={id(list_var)}")

f(regular_var, list_var)
print(f"after:           regular_var={regular_var}, location={id(regular_var)}, list_var={list_var}, location={id(list_var)}")